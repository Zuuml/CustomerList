...
public class ExceptionTests {
    ...
    private static final Logger logger = Logger.getLogger(ExceptionTests.class.getName());
    ...
    void lessThanFourElementsInputString() throws IOException{
    ...
    void wrongEmailFormatWithoutAt() throws IOException,RuntimeException{
